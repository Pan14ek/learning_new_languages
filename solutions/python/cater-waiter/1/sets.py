...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    dish_ingredients_without_duplicates = set(dish_ingredients)

    return (dish_name, dish_ingredients_without_duplicates)
...
def tag_special_ingredients(dish):
    ...
    dish_special_ingredients = SPECIAL_INGREDIENTS.intersection(dish_ingredients)
...
def separate_appetizers(dishes, appetizers):
    ...
    dishes_without_appetizers = unique_dishes.difference(unique_appetizers)

    return list(dishes_without_appetizers)
