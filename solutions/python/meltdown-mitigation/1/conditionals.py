...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    if product_of_temperature >= 500000:
        return False
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    threshold_ninty_percentage = (threshold * 90) / 100
    ...
    threshold_one_hundred_ten_percentage = (threshold * 110) / 100

    if criticality < threshold_ninty_percentage: 
        return 'LOW'
    elif criticality >= threshold_ninty_percentage and criticality <= threshold_one_hundred_ten_percentage:
        return 'NORMAL'
    else:
        return 'DANGER'