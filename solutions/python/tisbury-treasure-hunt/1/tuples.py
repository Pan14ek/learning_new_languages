...
def compare_records(azara_record, rui_record):
    ...
    first_coordinate = convert_coordinate(get_coordinate(azara_record))
    second_coordinate = get_coordinate(rui_record)

    for index, item in enumerate(first_coordinate):
        if item != second_coordinate[index]:
            return False
